...
class SearchConvPoint:
    """Search object for computing support points and neighborhoods as defined in ConvPoint paper.

    Computes the support points and their K-nearest neighbors according to the strategy defined in ConvPoint (https://github.com/aboulch/ConvPoint).
