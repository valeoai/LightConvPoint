...
class SearchRandom:
    """Search object for computing support points and neighborhoods with random
    selection.

    Computes the support points and their K-nearest neighbors according to a random
    selection strategy.
