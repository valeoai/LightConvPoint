...
class SearchFPS:
    """Search object for computing support points and neighborhoods with farthest point sammpling.

    Computes the support points and their K-nearest neighbors according to the strategy defined in PointNet++.
